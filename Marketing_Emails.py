...
# Queries for EmailQuery3 and EmailQuery4 require specific product IDs, instead of product group ID. Profile table joins with registration table to grab the product the user registered for. 
EmailQuery3 = """
